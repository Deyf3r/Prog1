...
('Deivi Aquino', 'deivi@gmail.com', '12345', 'Administrador'),
('Admin', 'admin', 'admin', 'Administrador'),
('Luis', 'luis@gmail.com', '12345', 'Asistente');
...
CREATE TABLE `venta` (
  ...
  `cantidadr` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `preciou` decimal(10,2) NOT NULL,
  `preciototal` varchar(20) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=UTF8_SPANISH_CI;

INSERT INTO `venta` (`id`, `descripcion`, `cantidadr`, `preciou`, `preciototal`) VALUES
(1, 'Laptop Dell', '1', '15000', '24000');
